const Mail = () => {
    ...
    return (
        <div className="flex justify-center gap-12 content-center font-custom-font bg-gray-dark py-10">
            <h3 className="max-w-xs text-sm font-bold text-white text-wrap pr-3">
                Отстъпки и специални предложения налични само на имейл
            </h3>
            <form className="flex flex-col gap-2">
                <div className="flex text-[10px]">
                    <input className="text-gray-tx p-0.5 pr-20" placeholder="Въведете вашия имейл"></input>
                    <button className="bg-red-bg text-white pr-5 end">Абонирай се</button>
                </div>
                <div>
